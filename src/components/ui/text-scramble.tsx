...
interface TextScrambleProps {
  text: string;
  className?: string;
  scrambleOn?: "hover" | "always";
}

export function TextScramble({ text, className = "", scrambleOn = "hover" }: TextScrambleProps) {
  ...
  return (
    ...
    >
      ...
      <span className="relative h-px w-full mt-1 overflow-hidden">
        <span
          className={`absolute inset-0 bg-primary transition-transform duration-500 ease-out origin-left ${
